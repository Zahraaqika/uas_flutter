...
import 'package:uas_project/screens/profile/header.dart';
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  get datas => <ProfileOption>[
        ProfileOption.arrow(
            title: 'Edit Profil', icon: _profileIcon('user@2x.png')),
        ProfileOption.arrow(
            title: 'Alamat', icon: _profileIcon('location@2x.png')),
        ProfileOption.arrow(
            title: 'Notifikasi', icon: _profileIcon('notification@2x.png')),
        ProfileOption.arrow(
            title: 'Pembayaran', icon: _profileIcon('wallet@2x.png')),
        ProfileOption.arrow(
            title: 'Keamanan', icon: _profileIcon('shield_done@2x.png')),
        _languageOption(),
        _darkModel(),
        ProfileOption.arrow(
            title: 'Bantuan', icon: _profileIcon('info_square@2x.png')),
        ProfileOption.arrow(
